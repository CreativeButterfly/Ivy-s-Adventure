	...
	var TiledTilemap = exports.TiledTilemap = function (_ShaderTilemap) {
	    ...
	    _createClass(TiledTilemap, [{
	        ...
	        value: function _getAnimTileId(textureId, tileId) {
	            ...
	            var tileset = this.tiledData.tilesets[textureId];
	            var keyId = tileId + tileset.firstgid;
	            if (!tilesData) {
	                return tileId;
	            }
	            if (!tilesData[tileId]) {
	            ...
	            this._animFrame[keyId] = this._animFrame[keyId] || 0;
	            var frame = this._animFrame[keyId];
	            this._animFrame[keyId] = !!animation[frame] ? frame : 0;
	            frame = this._animFrame[keyId];
	            var duration = animation[frame].duration / 1000 * 60;
	            this._animDuration[keyId] = this._animDuration[keyId] || duration;
	            if (this._animDuration[keyId] <= 0) {
	                this._animDuration[keyId] = duration;
	            }
	        ...
	        value: function hideOnLevel(level) {
	            ...
	            try {
	                for (var _iterator13 = this._priorityTiles[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
...
/***/ function(module, exports) {
	...
	Game_Map.prototype._setupCollisionFull = function () {
	    ...
	    try {
	        for (var _iterator2 = this.tiledData.layers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            if (layerData.properties.collision !== "full" && layerData.properties.collision !== "up-left" && layerData.properties.collision !== "up-right" && layerData.properties.collision !== "down-left" && layerData.properties.collision !== "down-right") {
	                continue;
	            }
	...
	Game_Map.prototype._setupCollisionArrow = function () {
	    ...
	    try {
	        for (var _iterator5 = this.tiledData.layers[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	            var layerData = _step5.value;

	            if (!layerData.properties || !layerData.properties.collision) {
	                continue;
	            }

	            if (layerData.properties.collision !== "arrow") {
	                continue;
	            }
	...
	Game_Map.prototype._setupTiledEvents = function () {
	    ...
	    try {
	        for (var _iterator11 = this.tiledData.layers[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	            ...
	            try {
	                for (var _iterator12 = layerData.objects[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
...
/***/ function(module, exports) {
	...
	Game_Player.prototype.performTransfer = function () {
	    if (this.isTransferring()) {
	        ...
	        if (this._newMapId !== $gameMap.mapId() || this._needsMapReload || $gameMap.isTiledMap()) {
